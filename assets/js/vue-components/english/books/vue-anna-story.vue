...
<VueExercise><VueQuestion lg="en" :question=" {
		question: 'What does superstitious mean?',
		type: 'multiple choice',
		options: [{option:'That you believe in stuff that cannot be proven by science or justified by reason', correct: true },
     {option:'That you are a workaholic who does not sleep much', correct: false },
     {option:'That you are always on time', correct: false } 
     ]
	    }" :hasNextButton="false" /></VueExercise>

And Fred liked to compare himself to others and to his former self.
